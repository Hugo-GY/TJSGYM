 ...
 * Works with the unified /class-booking/ and /class-confirmation/ pages.
 *
 * Usage:
...
$gallery_folder = $class_config['settings']['modifier'];
?>
        ...
        <div class="container">
            ...
            <div class="comp-carousel" aria-label="<?php echo esc_attr($class_data['name']); ?> photos" tabindex="0">
                <div class="comp-carousel-main">
                    <?php
                    $gallery_base_url = get_template_directory_uri() . '/assets/images/classes/' . $gallery_folder . '/';
