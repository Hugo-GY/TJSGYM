...
FILES=(
  "$ROOT_DIR/index.html"
  "$ROOT_DIR/classes.html"
  "$ROOT_DIR/timetable.html"
  "$ROOT_DIR/contact.html"
  "$ROOT_DIR/faq.html"
  "$ROOT_DIR/news.html"
  "$ROOT_DIR/club-kit.html"
  "$ROOT_DIR/club-policy.html"
  "$ROOT_DIR/coaches.html"
  "$ROOT_DIR/history.html"
  "$ROOT_DIR/privacy-policy.html"
