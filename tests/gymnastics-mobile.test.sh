...
assert_regex 'Spring 2026 Gymnastics sessions' "$HTML_FILE"
assert_regex 'Summer 2026' "$HTML_FILE"
...
assert_regex 'Enquire' "$HTML_FILE"
...
assert_not_regex 'Ask us' "$HTML_FILE"
