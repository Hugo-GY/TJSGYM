...
assert_contains 'Spring 2026' "$HTML_FILE"
...
assert_contains 'aria-label="Spring 2026 Toddler Gym sessions"' "$HTML_FILE"
assert_not_contains 'aria-label="Summer 2026 Toddler Gym sessions"' "$HTML_FILE"
...
assert_contains '../contact.html' "$HTML_FILE"
