...
assert_contains 'comp-carousel-img comp-carousel-img--tiddler-third" src="../images/classes/tiddler/133.png"' "$HTML_FILE"
...
assert_contains '.comp-carousel-img--tiddler-third {' "$CSS_FILE"
